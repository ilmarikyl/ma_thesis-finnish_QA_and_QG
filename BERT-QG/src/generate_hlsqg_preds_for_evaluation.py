...
LOG_FILE_NAME = "hlsqg_m_bert-eval.log"
...
if __name__ == "__main__":
    ...
    with open('m-bert_v3_hslqg_eval-preds.json', 'w', encoding='utf8') as out1:
        out1.write(out_json)

    out_json2 = json.dumps(out_dict, ensure_ascii=False)

    with open('m-bert_v3_hslqg_eval-preds_BUP.json', 'w', encoding='utf8') as out2:
        out2.write(out_json2)

    with open('m-bert_v3_hslqg_eval-preds.json', 'r', encoding='utf8') as pred_f:
