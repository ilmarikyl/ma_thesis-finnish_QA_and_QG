...
class Config:
    ...
    txt_data_file_fmt = "para_60k_{split}.json"
    splits = [
        "train", "dev", "test"
    ]
    # splits = [
...
if __name__ == "__main__":
    ...
    # tokenizer = BertTokenizerWithHLAns.from_pretrained("TurkuNLP/bert-base-finnish-cased-v1")
    tokenizer = BertTokenizerWithHLAns.from_pretrained("bert-base-multilingual-cased")
