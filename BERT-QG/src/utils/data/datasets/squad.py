...
class QnGenHLCtxtDataset(Dataset):
    ...
    """
    FIELD_DTYPES = {
        "input_ids": np.int32, # oli np.int16 mutta jotkut yli oli 32767 (= liian isoja)
    ...
    def __init__(self, input_json,
        ...
        # print('self.packed_features 3 :', self.packed_features['input_ids']) # Tässä kohtaa on jo perseellään
    ...
    def pack_features(self):
        ...
        # print(packed_features['input_ids'][:5]) # Tässä kohtaa vielä mätsää
        # --------------------------------------
    ...
    def convert_example_to_feature(self, example):
        ...
        # TEMPORARY DEBUG
        # print('ctxt_toks:', ctxt_toks)
        # print('qn_toks:', qn_toks)
    ...
    def _select_context_docspan(self, example, context_toks, keyword_toks, max_ctxt_toks):
        ...
        # print('RÄH:', example)
        # print('context_toks:',context_toks)
        # print('keyword_toks:', keyword_toks)
