...
class SQuAD60kSplitsBuilder:
    ...
    def __init__(self, split_info_dir: PathType, output_dir: PathType, ds: SQuADTextDataset):
        ...
        # build doclist
        doclist_dir = Path(split_info_dir)
...
class ParagraphSQuAD60kSplitsBuilder(SQuAD60kSplitsBuilder):
    output_json_fmt: str = "para_60k_{split}.json"
