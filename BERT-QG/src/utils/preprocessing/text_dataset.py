...
class SQuADTextDataset:
    ...
    def __init__(self, data_dir: str):
        ...
        # log the split
        self.logger.info(f"Dealing with all Finnish data...")
...
class SQuADV1TextDataset(SQuADTextDataset):
    # train_file: str = "100_fin_questions.json"
    train_file: str = "all_finnish_qa_data-74328.json"
    dev_file: str = "all_finnish_qa_data-74328.json"
    version = "1.0"
