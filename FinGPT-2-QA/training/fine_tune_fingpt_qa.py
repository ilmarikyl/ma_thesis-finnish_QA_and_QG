...
def main(args):
    ...
    model_name = "../../../FinGPT-QG/gpt_base_model"
    tokenizer = AutoTokenizer.from_pretrained(model_name)
    torch.manual_seed(42)

    train_dataset = load_squad_dataset("../../../datasets/combined_TyDI-QA_and_SQuADv2-FIN-train-v1.json", tokenizer)
    ...
    training_args = TrainingArguments(output_dir=f'/scratch/project_2001403/ilmariky/{args.exp}',
                                    ...
                                    save_strategy="steps", save_steps=60000,
